...
public class Enviroment {
    ...
    /// Spped at which the line tracer moves. Default value is 200.
    ...
    public var movement: Movement = .infinit
    /// Number of sides on the polygon
    public var numberOfSides: Int = 6
    /// Delay between the commencement of the mouvement and the commencement of the tracing. Defaults to 0.5 seconds.
